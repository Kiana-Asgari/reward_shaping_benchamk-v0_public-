...
class SAC(object):
    ...
    def train(self, env, test_env, args=None):
        # Training loop
        total_numsteps = 0
        updates = 0
        for i_episode in itertools.count(1):
            ...
            if (i_episode + 1) % args.test_freq == 0:
                self.test(test_env=test_env, test_num=args.test_num)

            if updates > args.p_update_num:  # TODO
                break
    ...
    def test(self, test_env, test_num):
        ...
        print("|  Avg. Reward of {} Episodes: {}".format(episodes, round(avg_reward, 2)))
